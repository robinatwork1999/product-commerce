...
const AddressComponent = (props: { title: string; containerType: string; defaultValues: any; submitHandler: Function }) => {
                ...
                <form id="shippingAddress" onSubmit={handleSubmit(onSubmit)}>
                    <ul className="shipping-container__address">
                        ...
                        <li>
                            <label>
                                <span>Last Name</span>
                                <input type="text" placeholder="Last name" {...register('lastname', { required: true, maxLength: 80 })} />
                            </label>
                        </li>
                        <li>
                            <label>
                                <span>company</span>
                                <input type="text" placeholder="Company" {...register('company', { required: true, maxLength: 80 })} />
                            </label>
                        </li>
                        <li>
                            <label>
                        ...
                        <li>
                            <label>
                                <span>Region</span>
                                <input type="text" placeholder="Region" {...register('region', { required: true, maxLength: 80 })} />
                            </label>
                        </li>
                        <li>
                            <label>
                                <span>region_id</span>
                                <input type="text" placeholder="region_id" {...register('region_id', { required: true, maxLength: 80 })} />
                            </label>
                        </li>
                        <li>
                            <label>
